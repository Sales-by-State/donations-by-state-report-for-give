<?php
/**
 * Populates the report table from existing donations.
 *
...
/**
 * Walks every donation once, in ascending ID order.
 */
class Backfill {

	/**
	 * Option holding the highest donation ID processed so far.
	 */
	const CURSOR_OPTION = 'dbsgive_backfill_cursor';

	/**
	 * Process one batch.
	 *
	 * @param int $limit Donations per batch.
	...
	/**
	 * Number of donations still to be walked.
	 *
	 * @return int
	 */
	...
	/**
	 * Restart the import when the table is empty but the site has donations.
	 *
	 * @return void
	 */
